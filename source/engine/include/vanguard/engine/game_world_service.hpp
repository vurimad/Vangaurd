...
namespace vanguard::engine
{
    ...
    /// Managed owner of one Flecs-backed game world and its cell-streaming runtime system.
    ...
    public:
        ...
        [[nodiscard]] virtual GameWorldStatus Status() const noexcept = 0;
        [[nodiscard]] virtual game::GameWorld* World() noexcept = 0;
        [[nodiscard]] virtual entities::CellStreamingSystem* CellStreaming() noexcept = 0;
