...
namespace red
{
	...
	public:
		...
		// FileTime is based on the timestamp from redIO::SystemFile::GetTimestamp()
		static DateTime FromFileTime( Uint64 fileTimestamp ); // UTC
		static DateTime FromFileTimeToLocal( Uint64 fileTimestamp ); // local time
	...
	RED_INLINE void DateTime::operator=( const DateTime& other )
	{
		m_date = other.m_date;
		m_time = other.m_time;
	}
