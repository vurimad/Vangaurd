...
namespace game
{
	namespace data
	{
		namespace prv
		{
			// #########################################################
			// #########################################################
			// ### Temp implementation from ZLib					####
			// ### Needs to be replaced by official implementation	####
			// #########################################################
			// #########################################################
...
#define DO1 crc = crc_table[(( Uint32 )crc ^ (*buf++)) & 0xff] ^ (crc >> 8)
...
#define GF2_DIM 32      /* dimension of GF(2) vectors (length of CRC) */
			...
			/* ========================================================================= */
			static constexpr Uint32 gf2_matrix_times( Uint32 *mat, Uint32 vec )
			{
				Uint32 sum = 0;
				while ( vec )
				{
			...
			/* ========================================================================= */
			static constexpr void gf2_matrix_square( Uint32 *square, Uint32 *mat )
			{
				for ( Int32 n = 0; n < GF2_DIM; n++ )
			...
			{
				Uint32 even[ GF2_DIM ]{ 0 };    /* even-power-of-two zeros operator */
				Uint32 odd[ GF2_DIM ]{ 0 };     /* odd-power-of-two zeros operator */
...
#undef GF2_DIM
			...
			// #########################################################
			// #########################################################
			// ####### END OF TEMP IMPLEMENTATION, NEEDS SUPPORT #######
			// #########################################################
			// #########################################################
		}
	}
