...
namespace simd
{
	...
	public:
		...
		RED_INLINE void RotateDirection( const math::Quaternion& _quat, const Vector4& _direction );
		RED_INLINE void RotateDirectionUnsafe( const math::Quaternion& _quat, const Vector4& _direction );
		RED_INLINE void InverseRotateDirection( const math::Quaternion& _quat, const Vector4& _v );
