...
namespace math
{
	constexpr WorldPosition::WorldPosition( const WorldPosition& v )
		: x( v.x ), y( v.y ), z( v.z )
	{}


	constexpr WorldPosition::WorldPosition( const FixedPoint& v )
		:x( v ), y( v ), z( v )
	{}
	
	constexpr WorldPosition::WorldPosition( const FixedPoint& vx, const FixedPoint& vy, const FixedPoint& vz )
		: x( vx ), y( vy ), z( vz )
	{}

	RED_INLINE WorldPosition::WorldPosition( Float vx, Float vy, Float vz )
		: x( vx ), y( vy ), z( vz )
	{}


	RED_INLINE WorldPosition::WorldPosition( const Vector3& v )
		: x( v.X ), y( v.Y ), z( v.Z )
	{}

	RED_INLINE WorldPosition::WorldPosition( const Vector4& v )
		: x( v.X ), y( v.Y ), z( v.Z )
	{}
	...
	constexpr math::WorldPosition WorldPosition::ZEROS()
	{
