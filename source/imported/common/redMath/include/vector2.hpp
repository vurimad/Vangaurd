...
namespace math
{
	RED_FORCE_INLINE Vector2::Vector2( const Float x, const Float y )
		: X(x)
		, Y(y)
	{}

	RED_FORCE_INLINE Vector2::Vector2( const Vector2& v )
		: X(v.X)
		, Y(v.Y)
	{}

	RED_FORCE_INLINE Vector2::Vector2( const Vector3& v)
		: X(v.X)
		, Y(v.Y)
	{}

	RED_FORCE_INLINE Vector2::Vector2( const Vector4& v )
		: X(v.X)
		, Y(v.Y)
	{}

	RED_FORCE_INLINE Vector2::Vector2( const Float f[2] )
		: X(f[0])
		, Y(f[1])
	{}

	RED_FORCE_INLINE Vector2::Vector2( Float f )
		: X(f)
		, Y(f)
	{}
