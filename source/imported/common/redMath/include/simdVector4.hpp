...
{
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE Vector4::Vector4()
		: V( _mm_setzero_ps() )
	{
	}

	//////////////////////////////////////////////////////////////////////////
	RED_INLINE constexpr Vector4::Vector4( const Scalar& _v )
		: V( _v.V)
	{
	}

	//////////////////////////////////////////////////////////////////////////
	RED_INLINE constexpr Vector4::Vector4( const Vector4& _v )
		: V( _v.V )
	{
	...
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE Vector4::Vector4( const red::Float* _f )
		: V( _mm_load_ps( _f ) )
	{
	...
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE Vector4::Vector4( red::Float _x, red::Float _y, red::Float _z, red::Float _w )
	...
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE constexpr Vector4::Vector4( Quad _v )
		: V( _v )
	{
	...
	RED_INLINE Scalar Vector4::Length3() const
	{
		...
		Quad vB = _mm_add_ss( _mm_add_ss( _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 3, 0, 0, 0 ) ), _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 3, 1, 1, 1 ) ) ), _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 3, 2, 2, 2 ) ) );
		vB = _mm_sqrt_ss( vB );
	...
	{
		Quad vA = _mm_mul_ps( V, V );
		Quad vB = _mm_add_ss( _mm_add_ss( _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 0, 0, 0, 0 ) ), _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 1, 1, 1, 1 ) ) ), _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 2, 2, 2, 2 ) ) );
		return _mm_shuffle_ps( vB, vB, _MM_SHUFFLE( 0, 0, 0, 0 ) );
	}
	...
	{
		Quad vA = _mm_max_ss( _mm_shuffle_ps( V, V, _MM_SHUFFLE( 0, 0, 0, 0 ) ), _mm_max_ss( _mm_shuffle_ps( V, V, _MM_SHUFFLE( 1, 1, 1, 1 ) ), _mm_shuffle_ps( V, V, _MM_SHUFFLE( 2, 2, 2, 2 ) ) ) );
	...
	{
		Quad vA = _mm_min_ss( _mm_shuffle_ps( V, V, _MM_SHUFFLE( 0, 0, 0, 0 ) ), _mm_min_ss( _mm_shuffle_ps( V, V, _MM_SHUFFLE( 1, 1, 1, 1 ) ), _mm_shuffle_ps( V, V, _MM_SHUFFLE( 2, 2, 2, 2 ) ) ) );
		return _mm_shuffle_ps( vA, vA, _MM_SHUFFLE( 0, 0, 0, 0 ) );
	}
	...
	{
		return ( ( Xi & 0x7f800000 ) != 0x7f800000 && 
			( Yi & 0x7f800000 ) != 0x7f800000 &&
			( Zi & 0x7f800000 ) != 0x7f800000 &&
			( Wi & 0x7f800000 ) != 0x7f800000 );
	}
	...
	// TODO: optimize
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE void Vector4::InverseRotateDirection( const math::Quaternion& _quat, const Vector4& _v )
	{
		math::Vector4 v( _v.X, _v.Y, _v.Z, _v.W );
		RED_MATH_PARANOID_SANITY_CHECK(MAbs(_quat.MagnitudeSq() - 1.f) <= 0.00001f);
		math::Vector3 ret = _quat.Conjugate().Transform(v);
	...
	//////////////////////////////////////////////////////////////////////////
	RED_INLINE void Vector4::RotateDirection( const math::Quaternion& _quat, const Vector4& _direction )
	{
		math::Vector4 v( _direction.X, _direction.Y, _direction.Z, _direction.W );
		RED_MATH_PARANOID_SANITY_CHECK(MAbs(_quat.MagnitudeSq() - 1.f) <= 0.00001f);
		math::Vector3 ret = _quat.Transform(v);
	...
	RED_INLINE void Vector4::RotateDirectionUnsafe( const math::Quaternion& _quat, const Vector4& _direction )
	{
		math::Vector4 v( _direction.X, _direction.Y, _direction.Z, _direction.W );
		RED_MATH_PARANOID_SANITY_CHECK(MAbs(_quat.MagnitudeSq() - 1.f) <= 0.00001f);
		math::Vector3 ret = _quat.TransformUnsafe(v);
