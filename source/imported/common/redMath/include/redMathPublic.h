...
// use this macro to enable additional sanity checks in structs like Transform, WorldTransform, simd::QsTransform
//#define RED_MATH_USE_PARANOID_SANITY_CHECK
#ifdef RED_MATH_USE_PARANOID_SANITY_CHECK
#define RED_MATH_PARANOID_SANITY_CHECK(x) { RED_MATH_ASSERT( x ); }
#else
