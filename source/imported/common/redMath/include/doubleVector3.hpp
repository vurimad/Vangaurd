...
namespace math
{
	...
	RED_FORCE_INLINE DoubleVector3::DoubleVector3( Double _x, Double _y, Double _z )
		: X( _x )
		, Y( _y )
		, Z( _z )
	{
	...
	RED_FORCE_INLINE DoubleVector3::DoubleVector3( const Double* ptr )
		: X( ptr[0] )
		, Y( ptr[1] )
		, Z( ptr[2] )
	{
	...
	RED_FORCE_INLINE DoubleVector3::DoubleVector3( const DoubleVector3& other )
		: X( other.X )
		, Y( other.Y )
		, Z( other.Z )
	{
	...
	RED_FORCE_INLINE DoubleVector3::DoubleVector3( const Vector3& vec, const Vector3& vecError )
		: X( (Double)vec.X + (Double)vecError.X )
		, Y( (Double)vec.Y + (Double)vecError.Y )
		, Z( (Double)vec.Z + (Double)vecError.Z )
	{
