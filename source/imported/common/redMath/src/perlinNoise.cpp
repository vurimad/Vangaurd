...
math::PerlinNoise::PerlinNoise( Uint32 seed )
{
	Seed( seed );
}

void math::PerlinNoise::Seed( Uint32 seed )
{
...
Float math::PerlinNoise::Get( Float x, Float y, Float z ) const
{
	...
	return math::Lerp( w, math::Lerp( v, math::Lerp( u, Grad( p[AA], x, y, z ),
		Grad( p[BA], x - 1, y, z ) ),
...
Float math::PerlinNoise::GetOctave( Float x, Int32 octaves ) const
{
	Float result = 0.0f;
	Float amp = 1.0f;
...
Float math::PerlinNoise::GetOctave( Float x, Float y, Float z, Int32 octaves ) const
{
	Float result = 0.0f;
	Float amp = 1.0f;
...
Float math::PerlinNoise::GetOctave( Float x, Float y, Int32 octaves ) const
{
	Float result = 0.0f;
	Float amp = 1.0f;
