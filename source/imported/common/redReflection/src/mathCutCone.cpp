...
void CutCone::RenderSolid(red::IShapeRenderer& renderer) const
{
	...
	Vector4 center2 = math::CutCone::GetPosition2();
	Vector4 center1 = math::CutCone::GetPosition(); 
...
void CutCone::RenderWireframe(red::IShapeRenderer& renderer) const
{
	const Uint16 numPoints = 30;
	const Uint16 totalVertices = ( numPoints + 1 ) * 2 + 2;
...
void CutCone::GenerateVertices(const Uint16 numPoints, Vector4* vertices) const
{
	Vector4 center2 = math::CutCone::GetPosition2();
	Vector4 center1 = math::CutCone::GetPosition(); 
	Vector4 norm = math::CutCone::GetNormal();
	Float radius1 = math::CutCone::GetRadius1();
	Float radius2 = math::CutCone::GetRadius2();
	...
	{
		vertices[ index++ ] = center1 + v * radius1;
		vertices[ index++ ] = center2 + v * radius2;
