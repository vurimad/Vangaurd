...
{	
	return RED_ALLOCATE( red::PoolLegacyOperator, size );
}	
...
{	
	if ( ptr )
	{
		RED_FREE( red::PoolLegacyOperator, ptr );
	}
}
...
// Standard operator delete size
void OP_DELETE( void *ptr, std::size_t ) throw( )
{
	if( ptr )
	{
		RED_FREE( red::PoolLegacyOperator, ptr );
...
// Array operator delete size
void OP_DELETE_ARRAY( void *ptr, std::size_t ) throw( )
{
	if( ptr )
	{
		RED_FREE( red::PoolLegacyOperator, ptr );
