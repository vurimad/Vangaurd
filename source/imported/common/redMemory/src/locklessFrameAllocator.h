...
#ifndef _RED_MEMORY_LOCKLESS_FRAME_ALLOCATOR_H_
#define _RED_MEMORY_LOCKLESS_FRAME_ALLOCATOR_H_
...
namespace memory
{
	class RED_ALIGN( 64 ) RED_MEMORY_API LocklessFrameAllocator : NonCopyable
	{
	public:
		
		RED_MEMORY_DECLARE_ALLOCATOR( LocklessFrameAllocator, FrameAllocatorMetrics, 8 );

		LocklessFrameAllocator();
		~LocklessFrameAllocator();
	...
	private:
		...
		Atomic< u64 > m_currentPositionInFrameBlock;
