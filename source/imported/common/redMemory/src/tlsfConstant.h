...
namespace memory
{
	...
	// These constant controls the minimum size to start segregating
	...
	const u32 c_tlsfSmallestAllocSizeToEnableBruteForceSearch = RED_MEGA_BYTE( 1 );
	...
	const u32 c_tlsfBlockStatusMask = 
		c_tlsfBlockFreeStatusMask | c_tlsfBlockPrevStateMask;	// Full mask
