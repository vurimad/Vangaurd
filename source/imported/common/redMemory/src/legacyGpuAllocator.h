...
namespace memory 
{
	...
	struct LegacyGpuAllocatorMetrics
	{
		AllocatorMetrics metrics;
	};

	class RED_MEMORY_API LegacyGpuAllocator
	{
	public:

		RED_MEMORY_DECLARE_ALLOCATOR( LegacyGpuAllocator, LegacyGpuAllocatorMetrics, 16 );
		...
		void RequestDefragmentation( DefragMoveRequestCallback moveRequestCb, void* userData = nullptr, DefragMode defragMode = DefragAll, u32 maxMemoryToMove = (u32)-1, u32 smallestGapToFill = 1024 * 4 );
