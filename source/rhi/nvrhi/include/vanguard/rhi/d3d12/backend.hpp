...
namespace vanguard::rhi::d3d12
{
    ...
    public:
        ...
        [[nodiscard]] BackendStatus Evict(containers::ArraySpan<const ResourceRef> resources,
                                          const ResidencyFenceSet& safeAfter) noexcept override;
        ...
        [[nodiscard]] BackendStatus WriteDescriptor(DescriptorDomainRef, DescriptorHandle,
                                                    AccelerationStructureRef) noexcept override;
        ...
        [[nodiscard]] AccelerationStructureRef CreateAccelerationStructure(
            const AccelerationStructureDesc&) noexcept override;
        ...
        [[nodiscard]] BackendStatus SetVariableRateShading(
            CommandListRef, const VariableRateShadingState&) noexcept override;
        ...
        [[nodiscard]] BackendStatus ClearColorTarget(CommandListRef, TextureRef, const ColorValue&,
                                                     const SubresourceRange&, const Rect*) noexcept override;
        [[nodiscard]] BackendStatus ClearDepthStencilTarget(CommandListRef, TextureRef, bool, f32, bool, u8,
                                                            const SubresourceRange&, const Rect*) noexcept override;
        [[nodiscard]] BackendStatus ClearTextureUav(CommandListRef, TextureRef, const ColorValue&,
                                                    const SubresourceRange&) noexcept override;
        [[nodiscard]] BackendStatus ClearTextureUav(CommandListRef, TextureRef, u32,
                                                    const SubresourceRange&) noexcept override;
        ...
        [[nodiscard]] BackendStatus BuildBottomLevelAccelerationStructure(
        ...
        [[nodiscard]] BackendStatus BuildTopLevelAccelerationStructure(
            CommandListRef, AccelerationStructureRef, containers::ArraySpan<const RayTracingInstanceDesc>,
            AccelerationStructureBuildMode) noexcept override;
        [[nodiscard]] BackendStatus BuildTopLevelAccelerationStructureIndirect(
            CommandListRef, AccelerationStructureRef, BufferRef, u64, u32,
            AccelerationStructureBuildMode) noexcept override;
        [[nodiscard]] BackendStatus CopyAccelerationStructure(
            CommandListRef, AccelerationStructureRef, AccelerationStructureRef,
            AccelerationStructureCopyMode) noexcept override;
        [[nodiscard]] BackendStatus WriteAccelerationStructureCompactedSize(
            CommandListRef, AccelerationStructureRef, QueryPoolRef, u32) noexcept override;
        [[nodiscard]] BackendStatus DispatchRays(CommandListRef, ShaderTableRef,
                                                 const DispatchRaysArguments&) noexcept override;
        ...
        [[nodiscard]] BackendStatus ResolveTexture(CommandListRef, TextureRef, TextureRef,
                                                    const TextureResolveRegion&) noexcept override;
        [[nodiscard]] BackendStatus RequestTextureReadback(CommandListRef, TextureRef, const TextureReadbackRegion&,
                                                           TextureReadbackRef&) noexcept override;
