...
namespace vanguard::rendering
{
    ...
    public:
        ...
        [[nodiscard]] bool Initialize(RenderSceneManager& scenes, GpuSceneLifetime& lifetime, const RenderSceneGpuConfig& config = {},
        ...
        [[nodiscard]] bool BindDecalMaterial(RenderProxyHandle proxy, GpuMaterialHandle material, RenderSceneGpuFailure* failure = nullptr) noexcept;
        [[nodiscard]] bool ClearDecalMaterialBinding(RenderProxyHandle proxy, RenderSceneGpuFailure* failure = nullptr) noexcept;
        ...
        [[nodiscard]] bool Prepare(RenderSceneHandle scene, u64 mutationEpoch, RenderSceneGpuPublication& publication,
                                   RenderSceneGpuFailure* failure = nullptr) noexcept;
        [[nodiscard]] bool BuildUploadRequests(const RenderSceneGpuPublication& publication, containers::DynamicArray<GpuSceneUploadRequest>& requests,
                                               RenderSceneGpuFailure* failure = nullptr) const noexcept;
        ...
        [[nodiscard]] bool WriteRange(const RenderSceneGpuPublication& publication, containers::ArraySpan<const GpuSceneUploadReservation> reservations,
                                      u32 rangeIndex, RenderSceneGpuFailure* failure = nullptr) noexcept;
