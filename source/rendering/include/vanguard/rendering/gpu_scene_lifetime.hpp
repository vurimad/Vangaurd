...
namespace vanguard::rendering
{
    ...
    struct GpuSceneAllocation
    {
        ...
        {
            return static_cast<u32>(table) < GpuSceneTableCount && first != InvalidGpuSceneIndex && count != 0 && generation != 0;
        }

        template <typename Handle> [[nodiscard]] constexpr Handle AsSlotHandle() const noexcept
        {
            return count == 1 ? Handle{first, generation} : Handle{};
        }

        [[nodiscard]] friend constexpr bool operator==(const GpuSceneAllocation&, const GpuSceneAllocation&) noexcept = default;
    };
    ...
    [[nodiscard]] constexpr GpuSceneQueueMask operator|(const GpuSceneQueueMask left, const GpuSceneQueueMask right) noexcept
    {
    ...
    struct GpuSceneLifetimeConfig
    {
        ...
        GpuSceneQueueMask retirementQueues = GpuSceneQueueMask::Graphics | GpuSceneQueueMask::Compute | GpuSceneQueueMask::Copy;
    };
    ...
    enum class GpuSceneLifetimeFailureCode : u8
    {
        ...
        ParallelTableHasNoIndependentLifetime,
        InvalidAllocation,
        InvalidState,
        DuplicateAllocation,
        MismatchedBatch,
    ...
    public:
        ...
        [[nodiscard]] bool ReserveCapacity(GpuSceneTableKind table, u32 requiredElements, GpuSceneLifetimeFailure* failure = nullptr) noexcept;

        [[nodiscard]] bool Allocate(GpuSceneTableKind table, u32 count, GpuSceneAllocation& allocation, GpuSceneLifetimeFailure* failure = nullptr) noexcept;
        ...
        [[nodiscard]] bool Retire(GpuSceneAllocation allocation, GpuSceneLifetimeFailure* failure = nullptr) noexcept;
        ...
        [[nodiscard]] GpuSceneAllocationState GetState(GpuSceneAllocation allocation) const noexcept;
