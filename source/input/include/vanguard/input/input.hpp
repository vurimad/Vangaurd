...
namespace vanguard::input
{
    ...
    enum class Key : u16
    {
        ...
        Right, Left, Down, Up, NumLock, KeypadDivide, KeypadMultiply, KeypadMinus, KeypadPlus,
        KeypadEnter, Keypad1, Keypad2, Keypad3, Keypad4, Keypad5, Keypad6, Keypad7, Keypad8,
        Keypad9, Keypad0, KeypadPeriod, NonUsBackslash, Application, Power, KeypadEquals,
        F13, F14, F15, F16, F17, F18, F19, F20, F21, F22, F23, F24,
        Execute, Help, Menu, Select, Stop, Again, Undo, Cut, Copy, Paste, Find, Mute, VolumeUp, VolumeDown,
        KeypadComma = 133, KeypadEqualsAs400,
        International1, International2, International3, International4, International5, International6,
        International7, International8, International9, Language1, Language2, Language3, Language4,
        Language5, Language6, Language7, Language8, Language9, AltErase, SysReq, Cancel, Clear, Prior,
        Return2, Separator, Out, Oper, ClearAgain, CrSel, ExSel,
        Keypad00 = 176, Keypad000, ThousandsSeparator, DecimalSeparator, CurrencyUnit, CurrencySubunit,
        KeypadLeftParenthesis, KeypadRightParenthesis, KeypadLeftBrace, KeypadRightBrace, KeypadTab,
        KeypadBackspace, KeypadA, KeypadB, KeypadC, KeypadD, KeypadE, KeypadF, KeypadXor, KeypadPower,
        KeypadPercent, KeypadLess, KeypadGreater, KeypadAmpersand, KeypadDoubleAmpersand, KeypadVerticalBar,
        KeypadDoubleVerticalBar, KeypadColon, KeypadHash, KeypadSpace, KeypadAt, KeypadExclamation,
        KeypadMemoryStore, KeypadMemoryRecall, KeypadMemoryClear, KeypadMemoryAdd, KeypadMemorySubtract,
        KeypadMemoryMultiply, KeypadMemoryDivide, KeypadPlusMinus, KeypadClear, KeypadClearEntry,
        KeypadBinary, KeypadOctal, KeypadDecimal, KeypadHexadecimal,
        LeftControl = 224, LeftShift, LeftAlt, LeftGui, RightControl, RightShift, RightAlt, RightGui,
        Mode = 257, Sleep, Wake, ChannelIncrement, ChannelDecrement, MediaPlay, MediaPause, MediaRecord,
        MediaFastForward, MediaRewind, MediaNextTrack, MediaPreviousTrack, MediaStop, MediaEject,
        MediaPlayPause, MediaSelect, ApplicationControlNew, ApplicationControlOpen, ApplicationControlClose,
        ApplicationControlExit, ApplicationControlSave, ApplicationControlPrint, ApplicationControlProperties,
        ApplicationControlSearch, ApplicationControlHome, ApplicationControlBack, ApplicationControlForward,
        ApplicationControlStop, ApplicationControlRefresh, ApplicationControlBookmarks,
    ...
    enum class GamepadButton : u8
    {
        ...
        Touchpad, Misc2, Misc3, Misc4, Misc5, Misc6, Count
    };
    enum class GamepadAxis : u8 { LeftX, LeftY, RightX, RightY, LeftTrigger, RightTrigger, Count };
    enum class DeviceType : u8 { Unknown, Keyboard, Mouse, Gamepad };
    enum class EventType : u8
    {
        KeyChanged, MouseButtonChanged, MouseMoved, MouseWheel, TextInput, GamepadButtonChanged,
        GamepadAxisChanged, DeviceConnected, DeviceDisconnected, FocusGained, FocusLost
    };
    ...
    struct RawEvent
    {
        ...
        union
        {
            struct { Key key; bool pressed; bool repeated; } key;
            struct { MouseButton button; bool pressed; u8 clicks; } mouseButton;
            struct { f32 x; f32 y; f32 deltaX; f32 deltaY; } mouseMotion;
            struct { f32 x; f32 y; } wheel;
            struct { GamepadButton button; bool pressed; } gamepadButton;
            struct { GamepadAxis axis; f32 value; } gamepadAxis;
            struct { char utf8[MaximumTextInputBytes]; u8 length; } text;
        } data{};
    };
    ...
    public:
        ...
        [[nodiscard]] virtual bool SetRumble(DeviceId device, f32 lowFrequency, f32 highFrequency,
