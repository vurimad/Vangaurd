...
namespace vanguard::math
{
    ...
    struct Half
    {
        ...
        RED_FORCE_INLINE static const Half Zero()
        {
            return Half(static_cast<Uint16>(0));
        }
    ...
    struct Half2
    {
        ...
        RED_FORCE_INLINE Half2(const Vector2 vec) : X(vec.X), Y(vec.Y) {}
    ...
    struct Half3
    {
        ...
        RED_FORCE_INLINE Half3(const Vector3 vec) : X(vec.X), Y(vec.Y), Z(vec.Z) {}
    ...
    static_assert(sizeof(Half) == 2, "Invalid vanguard::math::Half size");
    static_assert(sizeof(Half2) == 4, "Invalid vanguard::math::Half size");
    static_assert(sizeof(Half3) == 6, "Invalid vanguard::math::Half size");
    static_assert(sizeof(Half4) == 8, "Invalid vanguard::math::Half size");
