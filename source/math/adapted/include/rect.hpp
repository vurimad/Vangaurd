...
{
    constexpr Rect::Rect(const Box& box) : Rect{Int32(box.Min.X), Int32(box.Max.X), Int32(box.Min.Y), Int32(box.Max.Y)} {}
    ...
    constexpr Rect::Rect(Int32 left, Int32 right, Int32 top, Int32 bottom) : m_left(left), m_top(top), m_right(right), m_bottom(bottom) {}

    constexpr Rect::Rect(const Point& tl, const Point& br) : Rect{tl.x, br.x, tl.y, br.y} {}
