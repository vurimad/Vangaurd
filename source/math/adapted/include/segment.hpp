...
{
    RED_FORCE_INLINE Segment::Segment(const Segment& other) : Segment{other.m_origin, other.m_direction} {}

    RED_FORCE_INLINE Segment::Segment(const Vector4& origin, const Vector4& direction) : m_origin(origin), m_direction(direction) {}
