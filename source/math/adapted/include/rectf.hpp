...
{
    constexpr RectF::RectF(const Box& box) : RectF{box.Min.X, box.Max.X, box.Max.Y, box.Min.Y} {}

    constexpr RectF::RectF(Float left, Float right, Float top, Float bottom) : m_left(left), m_top(top), m_right(right), m_bottom(bottom) {}
