...
{
    RED_FORCE_INLINE Sphere::Sphere(const Vector4& geometry) : CenterRadius(geometry) {}

    RED_FORCE_INLINE Sphere::Sphere(const Vector4& center, Float radius) : CenterRadius{center.X, center.Y, center.Z, radius} {}

    RED_FORCE_INLINE Sphere::Sphere(Float c0, Float c1, Float c2, Float radius) : CenterRadius{c0, c1, c2, radius} {}
