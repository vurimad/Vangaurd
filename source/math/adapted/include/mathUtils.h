...
namespace vanguard::math
{
    namespace utils
    {
        ...
        // Solve quadratic equation in form of (ax^2 + bx + c == 0), solutions are given in x1 and x2. Returns false if there were no
        // solutions.
        ...
        template <typename T> T LowPassFilter(const T& raw, const T& current, Float rc, Float dt)
        {
