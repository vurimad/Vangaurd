...
namespace vanguard::math
{
    ...
    RED_INLINE CutCone::CutCone(const Vector4& pos1, const Vector4& pos2, Float radius1, Float radius2) : m_positionAndRadius1(pos1)
    {
        Vector4 d = (pos2 - pos1);
        m_height = d.Mag3();
    ...
    RED_INLINE CutCone::CutCone(const Vector4& pos, const Vector4& normal, Float radius1, Float radius2, Float height)
        : m_positionAndRadius1(pos.X, pos.Y, pos.Z, radius1), m_normalAndRadius2(normal.X, normal.Y, normal.Z, radius2), m_height(height)
    {
    }
