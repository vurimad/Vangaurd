...
namespace vanguard::math
{
    ...
    void CubicHermite_SIMD(Float out[4], const Float A[4], const Float B[4], const Float C[4], const Float D[4], const Float t[4])
    {
        ...
        const vanguard::math::simd::Quad a = _mm_add_ps(_mm_sub_ps(_mm_add_ps(_mm_mul_ps(neg_a, half), _mm_mul_ps(one_half, *(vanguard::math::simd::Quad*)B)),
                                                                   _mm_mul_ps(one_half, *(vanguard::math::simd::Quad*)C)),
                                                        _mm_mul_ps(half, *(vanguard::math::simd::Quad*)D));

        const vanguard::math::simd::Quad b =
            _mm_add_ps(_mm_sub_ps(*(vanguard::math::simd::Quad*)A, _mm_mul_ps(_mm_set_ps1(2.5f), *(vanguard::math::simd::Quad*)B)),
        ...
        const vanguard::math::simd::Quad a_t_cubed =
            _mm_mul_ps(*(vanguard::math::simd::Quad*)t, _mm_mul_ps(*(vanguard::math::simd::Quad*)t, _mm_mul_ps(*(vanguard::math::simd::Quad*)t, a)));
        const vanguard::math::simd::Quad b_t_squared = _mm_mul_ps(*(vanguard::math::simd::Quad*)t, _mm_mul_ps(*(vanguard::math::simd::Quad*)t, b));
        const vanguard::math::simd::Quad c_t = _mm_mul_ps(*(vanguard::math::simd::Quad*)t, c);

        *(vanguard::math::simd::Quad*)out = _mm_add_ps(_mm_add_ps(a_t_cubed, b_t_squared), _mm_add_ps(c_t, *(vanguard::math::simd::Quad*)B));
    }
    ...
    void QuadraticBezier_SIMD(Float out[4], const Float p0[4], const Float p1[4], const Float p2[4], const Float t[4])
    {
        ...
        *(vanguard::math::simd::Quad*)out = _mm_add_ps(
            _mm_add_ps(_mm_mul_ps(_mm_mul_ps(one_minus_t, one_minus_t), *(vanguard::math::simd::Quad*)p0),
                       _mm_mul_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(2.f), *(vanguard::math::simd::Quad*)t), one_minus_t), *(vanguard::math::simd::Quad*)p1)),
    ...
    void CubicBezier_SIMD(Float out[4], const Float p0[4], const Float p1[4], const Float p2[4], const Float p3[4], const Float t[4])
    {
        ...
        *(vanguard::math::simd::Quad*)out = _mm_add_ps(
            _mm_add_ps(_mm_mul_ps(_mm_mul_ps(_mm_mul_ps(one_minus_t, one_minus_t), one_minus_t), *(vanguard::math::simd::Quad*)p0),
            ...
            _mm_add_ps(
                _mm_mul_ps(_mm_mul_ps(_mm_mul_ps(_mm_set_ps1(3.f), _mm_mul_ps(*(vanguard::math::simd::Quad*)t, *(vanguard::math::simd::Quad*)t)), one_minus_t),
                           *(vanguard::math::simd::Quad*)p2),
                _mm_mul_ps(_mm_mul_ps(_mm_mul_ps(*(vanguard::math::simd::Quad*)t, *(vanguard::math::simd::Quad*)t), *(vanguard::math::simd::Quad*)t),
