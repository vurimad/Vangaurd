...
namespace vanguard::math
{
    ...
    {
        Matrix delta = {
            1.f, m_points[0].X, m_points[0].Y, m_points[0].Z, 1.f, m_points[1].X, m_points[1].Y, m_points[1].Z,
            1.f, m_points[2].X, m_points[2].Y, m_points[2].Z, 1.f, m_points[3].X, m_points[3].Y, m_points[3].Z,
        };
