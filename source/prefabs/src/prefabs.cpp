...
namespace
{
    ...
    constexpr u16 KnownEntityFlags = static_cast<u16>(prefab::EntityFlags::Root) | static_cast<u16>(prefab::EntityFlags::DisabledByDefault) |
                                     static_cast<u16>(prefab::EntityFlags::EditorOnly);
    constexpr u16 KnownComponentFlags = static_cast<u16>(prefab::ComponentFlags::DisabledByDefault) | static_cast<u16>(prefab::ComponentFlags::EditorOnly);
    ...
    [[nodiscard]] prefab::Result Convert(const serialization::Result result) noexcept
    {
        ...
        case serialization::Result::InvalidMagic:
            return prefab::Result::InvalidMagic;
        ...
        case serialization::Result::UnsupportedHeader:
            return prefab::Result::UnsupportedVersion;
        ...
        case serialization::Result::Overflow:
            return prefab::Result::LimitExceeded;
        ...
        case serialization::Result::EndOfStream:
            return prefab::Result::IoFailure;
        default:
    ...
    {
        return writer.WriteU64(reference.GetPath().Id()) && writer.WriteU32(reference.ExpectedType());
    }
    ...
    [[nodiscard]] bool DependencyLess(const prefab::DependencyRecord& left, const prefab::DependencyRecord& right) noexcept
    {
    ...
    [[nodiscard]] const prefab::EntityRecord* FindEntity(const containers::DynamicArray<prefab::EntityRecord>& entities, const u64 stableId) noexcept
    {
        u32 first = 0;
    ...
    [[nodiscard]] bool AddDependency(containers::DynamicArray<prefab::DependencyRecord>& dependencies, const resources::ResourceReference reference,
    ...
    [[nodiscard]] bool DependencyVisitor(const resources::ResourceReference reference, const resources::DependencyKind kind, void* const userData) noexcept
    {
    ...
    [[nodiscard]] prefab::Result Canonicalize(const prefab::CookDescription& description, CanonicalData& output) noexcept
    {
        if (description.name == 0 || description.entities.Empty())
            return prefab::Result::InvalidArgument;
        ...
        {
            if (source.stableId == prefab::InvalidStableId || (static_cast<u16>(source.flags) & ~KnownEntityFlags) != 0)
                return prefab::Result::InvalidArgument;
            if (!description.includeEditorData && (static_cast<u16>(source.flags) & static_cast<u16>(prefab::EntityFlags::EditorOnly)) != 0)
                continue;
            prefab::EntityFlags flags = source.flags;
            if (source.parentStableId == prefab::InvalidStableId)
                flags = flags | prefab::EntityFlags::Root;
            else
                flags = static_cast<prefab::EntityFlags>(static_cast<u16>(flags) & ~static_cast<u16>(prefab::EntityFlags::Root));
            output.entities.PushBack({source.stableId, source.parentStableId, source.name, 0, 0, flags});
        }
        if (output.entities.Empty())
            return prefab::Result::InvalidArgument;
        ...
        if (result != prefab::Result::Success)
            return result;
        ...
        {
            if (source.stableId == prefab::InvalidStableId || source.entityStableId == prefab::InvalidStableId || source.schema == nullptr ||
                source.object == nullptr || !static_cast<bool>(*source.schema) || (static_cast<u16>(source.flags) & ~KnownComponentFlags) != 0)
                return prefab::Result::InvalidArgument;
            if (!description.includeEditorData && (static_cast<u16>(source.flags) & static_cast<u16>(prefab::ComponentFlags::EditorOnly)) != 0)
                continue;
            if (FindEntity(output.entities, source.entityStableId) == nullptr)
                return prefab::Result::MissingParent;
        ...
        for (u32 index = 1; index < componentIds.Size(); ++index)
            if (componentIds[index - 1u] == componentIds[index])
                return prefab::Result::DuplicateIdentifier;
        ...
        for (const ComponentSource& sorted : sources)
        {
            ...
            if (!AlignData(output.componentData, 8))
                return prefab::Result::LimitExceeded;
            ...
            if (!AppendBytes(output.componentData, bytes.Data(), bytes.Size()))
                return prefab::Result::LimitExceeded;
        ...
        {
            while (componentIndex < output.components.Size() && output.components[componentIndex].entityStableId < entity.stableId)
                ++componentIndex;
        ...
        if (componentIndex != output.components.Size())
            return prefab::Result::InvalidLayout;
    ...
    [[nodiscard]] bool WriteEntity(serialization::BinaryWriter& writer, const prefab::EntityRecord& value) noexcept
    {
        return writer.WriteU64(value.stableId) && writer.WriteU64(value.parentStableId) && writer.WriteU64(value.name) &&
               writer.WriteU32(value.firstComponent) && writer.WriteU32(value.componentCount) && writer.WriteU16(static_cast<u16>(value.flags)) &&
               writer.WriteU16(0);
    }
    ...
    [[nodiscard]] bool ReadEntity(serialization::BinaryReader& reader, prefab::EntityRecord& value) noexcept
    {
        u16 flags = 0;
        u16 reserved = 0;
        if (!reader.ReadU64(value.stableId) || !reader.ReadU64(value.parentStableId) || !reader.ReadU64(value.name) || !reader.ReadU32(value.firstComponent) ||
            !reader.ReadU32(value.componentCount) || !reader.ReadU16(flags) || !reader.ReadU16(reserved))
            return false;
        value.flags = static_cast<prefab::EntityFlags>(flags);
        return reserved == 0;
    }

    [[nodiscard]] bool WriteComponent(serialization::BinaryWriter& writer, const prefab::ComponentRecord& value) noexcept
    {
        return writer.WriteU64(value.stableId) && writer.WriteU64(value.entityStableId) && writer.WriteU64(value.schema) &&
               writer.WriteU16(value.schemaVersion) && writer.WriteU16(static_cast<u16>(value.flags)) && writer.WriteU64(value.dataOffset) &&
               writer.WriteU64(value.dataSize) && WriteDigest(writer, value.dataFingerprint);
    }

    [[nodiscard]] bool ReadComponent(serialization::BinaryReader& reader, prefab::ComponentRecord& value) noexcept
    {
        u16 flags = 0;
        if (!reader.ReadU64(value.stableId) || !reader.ReadU64(value.entityStableId) || !reader.ReadU64(value.schema) || !reader.ReadU16(value.schemaVersion) ||
            !reader.ReadU16(flags) || !reader.ReadU64(value.dataOffset) || !reader.ReadU64(value.dataSize) || !ReadDigest(reader, value.dataFingerprint))
            return false;
        value.flags = static_cast<prefab::ComponentFlags>(flags);
        return true;
    }

    [[nodiscard]] bool WriteDependency(serialization::BinaryWriter& writer, const prefab::DependencyRecord& value) noexcept
    {
        return WriteReference(writer, value.resource) && writer.WriteU8(static_cast<u8>(value.kind)) && writer.WriteU8(0) && writer.WriteU16(0);
    }

    [[nodiscard]] bool ReadDependency(serialization::BinaryReader& reader, prefab::DependencyRecord& value) noexcept
    {
        u8 kind = 0;
        u8 reserved8 = 0;
        u16 reserved16 = 0;
    ...
    [[nodiscard]] prefab::Result BuildBody(const CanonicalData& data, ByteArray& body, crypto::Digest256& fingerprint) noexcept
    {
        filesystem::MemoryFileWriter file(body);
        serialization::BinaryWriter writer(file);
        if (!writer.WriteU64(data.name) || !WriteDigest(writer, data.sourceFingerprint) || !writer.WriteU32(data.entities.Size()) ||
            !writer.WriteU32(data.components.Size()) || !writer.WriteU32(data.dependencies.Size()) || !writer.WriteU64(data.componentData.Size()))
            return WriterResult(writer);
        for (const prefab::EntityRecord& entity : data.entities)
            if (!WriteEntity(writer, entity))
                return WriterResult(writer);
        for (const prefab::ComponentRecord& component : data.components)
            if (!WriteComponent(writer, component))
                return WriterResult(writer);
        for (const prefab::DependencyRecord& dependency : data.dependencies)
            if (!WriteDependency(writer, dependency))
                return WriterResult(writer);
        if (!writer.WriteBytes(data.componentData.Data(), data.componentData.Size()))
            return WriterResult(writer);
        fingerprint = crypto::Sha256(body.Data(), body.Size());
        return prefab::Result::Success;
    }

    [[nodiscard]] prefab::Result WriteDocument(filesystem::IFile& file, const ByteArray& body, const crypto::Digest256& fingerprint) noexcept
    {
    ...
    {
        const auto entities = file.GetEntities();
        const auto components = file.GetComponents();
        const auto dependencies = file.GetDependencies();
        if (file.GetName() == 0 || entities.Empty())
            return prefab::Result::InvalidLayout;
        ...
        for (u32 index = 0; index < entities.Size(); ++index)
        {
            ...
            if (entity.stableId == prefab::InvalidStableId || (index > 0 && entities[index - 1u].stableId >= entity.stableId) ||
                (static_cast<u16>(entity.flags) & ~KnownEntityFlags) != 0 || root != rootFlag || entity.firstComponent != expectedComponent ||
                entity.componentCount > components.Size() - expectedComponent)
                return prefab::Result::InvalidLayout;
        ...
        for (u32 index = 0; index < components.Size(); ++index)
        {
            ...
            const auto bytes = file.GetComponentData(component);
            expectedDataOffset = (expectedDataOffset + 7u) & ~7ull;
            if (component.stableId == prefab::InvalidStableId || component.schema == reflection::InvalidSchemaTypeId || component.schemaVersion == 0 ||
                (static_cast<u16>(component.flags) & ~KnownComponentFlags) != 0 || component.dataSize == 0 || component.dataOffset != expectedDataOffset ||
                bytes.Size() != component.dataSize)
                return prefab::Result::InvalidLayout;
            if (crypto::Sha256(bytes.Data(), bytes.Size()) != component.dataFingerprint)
                return prefab::Result::IntegrityFailure;
            if (index > 0 && components[index - 1u].entityStableId == component.entityStableId && components[index - 1u].stableId >= component.stableId)
                return prefab::Result::InvalidLayout;
            componentIds.PushBack(component.stableId);
            if (componentIds.Size() != index + 1u)
                return prefab::Result::LimitExceeded;
        ...
        for (u32 index = 0; index < dependencies.Size(); ++index)
        {
            ...
            if (!dependency.resource.IsValid() || !dependency.resource.IsTyped() || dependency.kind > resources::DependencyKind::Soft ||
...
namespace vanguard::prefabs
{
    ...
    Result PrefabFile::Open(filesystem::IFile& file, const ReadLimits& limits) noexcept
    {
        ...
        const serialization::Result headerResult = serialization::ReadDocumentHeader(reader, PrefabMagic, {1, 0, 0}, documentLimits, header);
        ...
        if (sectionResult != serialization::Result::Success)
            return Convert(sectionResult);
        if (sections.Size() != 1 || sections[0].id != PrefabSection || sections[0].version != FileVersion || sections[0].codec != serialization::Codec::None ||
        ...
        if (!bodyReader.ReadU64(m_name) || !ReadDigest(bodyReader, m_sourceFingerprint) || !bodyReader.ReadU32(entityCount) ||
            !bodyReader.ReadU32(componentCount) || !bodyReader.ReadU32(dependencyCount) || !bodyReader.ReadU64(componentDataSize))
            return ReaderResult(bodyReader);
        const u32 maximumComponentData = limits.maximumComponentDataBytes > 0xffffffffull ? 0xffffffffu : static_cast<u32>(limits.maximumComponentDataBytes);
        if (componentDataSize > limits.maximumComponentDataBytes || componentDataSize > 0xffffffffull ||
            !ResizeChecked(m_entities, entityCount, limits.maximumEntities) || !ResizeChecked(m_components, componentCount, limits.maximumComponents) ||
        ...
        for (EntityRecord& entity : m_entities)
            if (!ReadEntity(bodyReader, entity))
                return Result::InvalidLayout;
        for (ComponentRecord& component : m_components)
            if (!ReadComponent(bodyReader, component))
                return Result::InvalidLayout;
        for (DependencyRecord& dependency : m_dependencies)
            if (!ReadDependency(bodyReader, dependency))
                return Result::InvalidLayout;
        if (!bodyReader.ReadBytes(m_componentData.Data(), m_componentData.Size()))
            return ReaderResult(bodyReader);
    ...
    bool PrefabFile::IsOpen() const noexcept
    {
        return m_open;
    }
    u64 PrefabFile::GetName() const noexcept
    {
        return m_name;
    }
    const crypto::Digest256& PrefabFile::GetSourceFingerprint() const noexcept
    {
        return m_sourceFingerprint;
    }
    const crypto::Digest256& PrefabFile::GetContentFingerprint() const noexcept
    {
        return m_contentFingerprint;
    }
    containers::ArraySpan<const EntityRecord> PrefabFile::GetEntities() const noexcept
    {
        return m_entities;
    }
    containers::ArraySpan<const ComponentRecord> PrefabFile::GetComponents() const noexcept
    {
        return m_components;
    }
    containers::ArraySpan<const DependencyRecord> PrefabFile::GetDependencies() const noexcept
    {
        return m_dependencies;
    }

    containers::ArraySpan<const u8> PrefabFile::GetComponentData(const ComponentRecord& component) const noexcept
    {
        if (!m_open || component.dataOffset > m_componentData.Size() || component.dataSize > m_componentData.Size() - component.dataOffset ||
            component.dataSize > 0xffffffffull)
            return {};
    ...
    {
        if (!m_open || stableId == InvalidStableId)
            return nullptr;
        for (const ComponentRecord& component : m_components)
            if (component.stableId == stableId)
                return &component;
        return nullptr;
    }

    resources::ResourceTypeId PrefabResource::GetType() const noexcept
    {
        return PrefabResourceType;
    }
    ...
    const PrefabFile& PrefabResource::GetFile() const noexcept
    {
        return m_file;
    }
