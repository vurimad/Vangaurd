...
project "prefabs"
    ...
    includedirs {
        ...
        "../reflection/include", "../schemas/include"
    }
    links { "schemas", "reflection", "serialization", "crypto", "resources", "filesystem", "containers", "memory", "system" }
    vpaths {
...
project "prefabsTests"
    ...
    includedirs {
        ...
        "../reflection/include", "../schemas/include", "../packages/include"
    }
    importedIncludes()
    libdirs { path.join(nvToolsRoot, "lib/x64.Release") }
    links {
        "prefabs", "schemas", "reflection", "packages", "resources", "crypto", "serialization", "serializationCompat",
