...
project "world"
    ...
    includedirs {
        ...
        "../reflection/include", "../schemas/include", "../prefabs/include", "../meshes/include", "../jobs/include"
    }
    links { "meshes", "prefabs", "schemas", "reflection", "serialization", "crypto", "resources", "filesystem", "containers", "memory", "system" }
    vpaths {
...
project "worldTests"
    ...
    includedirs {
        ...
        "../reflection/include", "../schemas/include", "../prefabs/include", "../meshes/include", "../packages/include",
        "../concurrency/include", "../jobs/include"
    }
    importedIncludes()
    libdirs { path.join(nvToolsRoot, "lib/x64.Release") }
    links {
        "world", "meshes", "prefabs", "schemas", "reflection", "packages", "resources", "crypto", "serialization",
        "serializationCompat", "filesystem", "filesystemCompat", "redFileSystemCompat", "redCompressionCompat",
        "redCoreCompat", "redIOCompat", "redContainersCompat", "redMathCompat", "io", "diagnostics",
        "diagnosticsCompat", "containers", "containersCompat", "concurrency", "concurrencyCompat", "jobs", "jobsCompat",
        "redJobsCompat", "memory", "redSystemCompat", "system", "nvToolsExt64_1",
        "Advapi32", "Dbghelp", "Psapi", "Shlwapi", "Shell32", "Version", "ws2_32"
    }
